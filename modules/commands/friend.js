...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage("ᴘʟᴇᴀꜱᴇ ᴍᴇɴᴛɪᴏɴ 1 ᴘᴇʀꜱᴏɴ.", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "ɴᴏʙɪᴛᴀ-ᴄʜᴀᴛ ʙᴏᴛ ᴀᴘɪ...✨💖\n\nᴄʀᴇᴅɪᴛ : ꜱʜᴀᴡᴏɴ ꜱʜᴇɪᴋʜ😘", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
      }
